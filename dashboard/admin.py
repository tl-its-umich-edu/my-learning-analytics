...
class CourseAdmin(admin.ModelAdmin):
    ...
    form = CourseForm
    fields = ('canvas_id', 'name', 'term', 'date_start', 'date_end', 'show_grade_counts', 'show_grade_type', 'data_last_updated', 'created_date')
    list_display = ('canvas_id', 'name', 'term', 'show_grade_counts', 'course_link', '_courseviewoption', 'data_last_updated', 'created_date')
    list_select_related = True
    readonly_fields = ('term', 'data_last_updated', 'created_date')
