...
def get_last_cron_run():
    """[Get the last time a cron was run]
    
    :return: [Value for the last time a cron was run, if there was an error returns datetime.min]
    :rtype: [datetime]
    """
...
def get_canvas_data_date():
    """[Get the date when canvasdatadate was last refreshed]
