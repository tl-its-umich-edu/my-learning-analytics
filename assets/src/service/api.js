...
export const useAssignmentData = (courseId, assignmentGradeFilter, fetchAfter) => {
  return useFetch(`/api/v1/courses/${courseId}/assignments?percent=${assignmentGradeFilter}`, false, fetchAfter)
}
