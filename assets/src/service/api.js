...
export const useInfoData = (currentCourseId) => useFetch(`http://localhost:5001/api/v1/courses/${currentCourseId}/info`)
export const useUserSettingData = (currentCourseId) => useFetch(`http://localhost:5001/api/v1/courses/${currentCourseId}/get_user_default_selection`)